...
export default class Login extends React.Component<Props, State> {
  ...
  render() {
    return (
      <Card containerStyle={{ borderRadius: 8, shadowColor: "#E7E4E7", padding: 8 }}>
        <View style={styles.post_container}>
          ...
          {this.props.data.postType === 0 ?
            < Text style={{ fontSize: 16 }}>{this.props.data.postBody}</Text>
            : <Image
              source={{ uri: this.props.data.postBody }}
